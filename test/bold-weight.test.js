...
// The browser's own rule for `b` and `strong` is `font-weight: bolder`, which is relative: from a
// 300 body it computes to 400, one step up rather than bold. Live declares it flat, `body strong
// {font-weight:700}`, so its bold is 300 to 700 where ours was 300 to 400.
//
// This is on every page with emphasis, and a58718e took the estate to 4,423 bold and italic runs.
// Ported from da-ram #58.
describe('bold text', () => {
